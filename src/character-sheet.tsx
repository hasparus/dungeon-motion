...
function CombatShapes() {
  return (
    <div className="flex justify-center items-end gap-8">
      <ShapedStat
        className="-translate-y-1.5 -translate-x-0.5"
        filled
        label="HP"
        name="hp"
        viewBox="0 0 250 250"
      ...
      <ShapedStat filled label="Damage" name="damage" viewBox="30 0 196 256">
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative w-20 h-20">
        ...
        <input
          className={cn(
            "absolute inset-0 w-full h-full text-center font-hand text-5xl bg-transparent text-stone-800 dark:text-stone-200 focus:outline-none",
            className,
          )}
          name={name}
          type="text"
